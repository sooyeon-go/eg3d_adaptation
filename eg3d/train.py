...
import dnnlib
from training import training_loop_nada,training_loop
...
def subprocess_fn(rank, c, temp_dir):
    ...
    training_loop_nada.training_loop(rank=rank, **c)
...
def init_dataset_kwargs(data):
    try:
        dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset.ImageFolderDataset', path=data, use_labels=True, max_size=8, xflip=False)
